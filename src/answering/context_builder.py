...
def expand_adjacent_evidence(
    ...
    *,
    ...
    Returns:
        Ordered list [.., prev, focus, next, ..] of distinct blocks. If the
        focus block is not found, returns the input list unchanged.
    """
    if not blocks or focus_block_id is None:
    ...
    return [indexed[bid] for bid in sorted_ids[lo:hi]]
